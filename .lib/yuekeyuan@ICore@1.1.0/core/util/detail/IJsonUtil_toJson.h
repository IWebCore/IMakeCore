...
inline IJson toJson(const QTime& time) { return time.toString(Qt::ISODate).toStdString();}
inline IJson toJson(const QDateTime& time) { return time.toString(Qt::ISODate).toStdString();}
